        ...
        <div className="contact-form-container">
            <form onSubmit={handleSubmit} className={`contact-form ${isSubmitted ? 'submitted' : ''}`} aria-hidden={isSubmitted}>
                ...
                <div className="form-group">
                    ...
                    <textarea id="message-contact" name="message" rows={8} required></textarea>
                </div>
  ...
  return (
    <>
      <section className="contact-hero-section scroll-trigger fade-up">
        <div className="container">
          <h1 className="scroll-trigger fade-up" style={{transitionDelay: '0.1s'}}>Contact <strong>Us</strong></h1>
        ...
        <div className="container">
          <div className="contact-grid">
            <div className="contact-info scroll-trigger fade-up" style={{transitionDelay: '0.1s'}}>
                <h3>Get in Touch</h3>
                <p>Whether you have a question about our services, a project proposal, or anything else, our team is ready to answer all your questions.</p>
                <ul className="contact-details">
                    <li><i className="fas fa-map-marker-alt" aria-hidden="true"></i><span>14th floor, Al Jazeera tower, Westbay, Doha Qatar</span></li>
                    <li><i className="fas fa-phone" aria-hidden="true"></i><a href="tel:+97477123400">+974 7712 3400</a></li>
                    <li><i className="fas fa-envelope" aria-hidden="true"></i><a href="mailto:info@tajdc.com">info@tajdc.com</a></li>
                </ul>
                <div className="contact-map">
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3606.393430489247!2d51.52389131501211!3d25.3245469838367!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e45c4c70a3120fd%3A0x1c374c34823c3a40!2sAl%20Jazeera%20Tower!5e0!3m2!1sen!2sqa!4v1672583845961!5m2!1sen!2sqa" 
                        width="600" 
                        height="450" 
                        style={{ border: 0 }} 
